        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-6 text-center lg:text-left">
                ...
                <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-2">
                    <Link
                        href="#catalogo"
                        className="bg-electric-violet hover:bg-violet-700 text-white font-semibold px-6 py-3 rounded-xl transition-all">
                        Explorar Catálogo
                    </Link>
                    <Link
                        href="/sobre"
                        className="border border-white/20 hover:bg-white/10 text-white font-semibold px-6 py-3 rounded-xl transition-all">
                        Conheça a Loja
                    </Link>
                </div>
            </div>
            ...
            <div className="bg-zinc-900/80 border border-white/10 p-6 rounded-2xl flex flex-col sm:flex-row gap-6 items-center shadow-2xl">
                ...
                <div className="flex flex-col gap-3 text-center sm:text-left">
                    ...
                    <h3 className="text-2xl font-bold font-alkalami">Jujutsu Kaisen Vol. 1</h3>
                    ...
                    <span className="text-2xl font-bold text-deep-lime-green">
                        R$ 34,90
                    </span>
                    <button className="bg-persian-red items-center flex flex-row gap-2 justify-center hover:opacity-90 text-white font-bold px-4 py-2 rounded-lg text-sm transition-all">
                        <ShoppingCart  className="text-white"/> Adicionar
                    </button>
                    </div>
                </div>
            </div>
